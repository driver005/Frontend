...
import { Controls, PlayState, Timeline, Tween, ScrollTrigger as ScrollT } from 'react-gsap';
import { Scene } from 'react-scrollmagic';
import { Scrollsegment } from './styles';
    ...
    useEffect(() => {
        ...
        gsap.to("#fstar", {
            ...
            scrollTrigger: {
                ...
                scrub: 5,
                onEnter: function () { gsap.to("#fstar", { opacity: 1 }) },
                onLeave: function () { gsap.to("#fstar", { opacity: 0 }) },
            }
        })
    ...
    return (
        <Scrollsegment>
            <ScrollT
                ...
                scrub={0.5}
                markers
                onEnter={function () { gsap.to("#showsvgscrollanimations", { position: 'fixed', top: 0, left: 0, height: '100vh', width: '100vw' }) }}
                onLeave={function () { gsap.to("#showsvgscrollanimations", { position: 'relative', }) }}
                onEnterBack={function () { gsap.to("#showsvgscrollanimations", { position: 'fixed', top: 0, left: 0, height: '100vh', width: '100vw' }) }}
                onLeaveBack={function () { gsap.to("#showsvgscrollanimations", { position: 'relative', }) }}
            ...
            >
                ...
                >
                    <svg id={'showsvgscrollanimations'} className={'mainsvg'} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 750 500" preserveAspectRatio="xMidYMax slice">
                        <defs>
                        ...
                        <g id="scene3" style={{ visibility: "hidden" }}>
                            ...
                            <g id="fstar">
                                ...
                                <circle cx="768.6" cy="78.72" r="39.39" transform="translate(64.22 396.2) rotate(-30.11)"
                                    fill="url(#fstar-grad)" style={{ mixBlendMode: "multiply" }} />
                            </g>

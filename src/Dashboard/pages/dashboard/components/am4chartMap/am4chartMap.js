...
import { Mapcontainer, Maptextcontainer, Maptexth6, Maptextmain, Maptextp, Maptextspan } from '../../../../styles/charts';
  ...
  render() {
    return (
      <Maptextcontainer>
        <Maptextmain>
          <Maptexth6 className="mt-1">GEO-LOCATIONS</Maptexth6>
          <Maptextp className="h3 m-0">
            <Maptextspan className="mr-xs fw-normal">
              <AnimateNumber
                value={1656843}
                initialValue={0}
                duration={1000} 

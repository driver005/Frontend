...
const Core = ({questions, appLocale, showDefaultResult, onComplete, customResultPage, showInstantFeedback, continueTillCorrect}) => {
  ...
  const renderAnswerInResult = (question, userInputIndex, Index) => {
    const {answers, correctAnswer, questionType, input} = question;
    let {answerSelectionType} = question;
    let answerBtnCorrectClassName;
    let answerBtnIncorrectClassName;
    let answerBtnCorrectClassNameInput;
    let answerBtnIncorrectClassNameInput;
      ...
      return (
          <div key={index}>
            {input ? 
              <Fragment>
                <input
                  className={"answerBtn btn " + answerBtnCorrectClassNameInput + answerBtnIncorrectClassNameInput}
                  value={answer}
                  disabled={true}
                />
              </Fragment> 
      ...
      return (
          <div className="result-answer-wrapper" key={index + 1}>
            ...
            <div className="result-answer">
              {renderAnswerInResult(question, userInputIndex, index)}
            </div>
